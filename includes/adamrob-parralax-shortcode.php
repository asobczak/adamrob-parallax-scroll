...
function register_sc_parallax_scroll( $atts ) {
 ...
 //AJR       	//Check if Scroll Is Enabled
            ...
            $ParallaxSizeStyle='background-size: 100%;';
            if (wp_is_mobile()==FALSE && $psize>0){
                ...
                $ParallaxSizeStyle='background-size: contain; background-attachment: scroll;';
            }elseif(wp_is_mobile()&&isset($mobpsize)&&$mobpsize>0){
            ...
            if(0 && wp_is_mobile()&&isset($mobpsize)){
                ...
                $output .= '<section id="parallax_'.$postid.'" class="adamrob_parallax '.$parallaxFWStyleClass.$parallaxScrollingClass.'" style="'.$parallaxStyle.$ParallaxImgStyle.$ParallaxSizeStyle.'">';
            }
